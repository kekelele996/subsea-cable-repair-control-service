...
func NewChemicalAssessment(cable, window string, spans []string, signals map[string]float64) ChemicalAssessment {
	...
	return ChemicalAssessment{CableID: strings.TrimSpace(cable), Window: strings.TrimSpace(window), Spans: copied, Signals: signalCopy}
}

func (a ChemicalAssessment) NormalizeSpans() []string {
...
func (a ChemicalAssessment) Result() ChemicalResult {
	...
	return ChemicalResult{Score: score, Band: band, Review: score >= 18, Reasons: reasons, Normalized: a.NormalizeSpans()}
}

func (a ChemicalAssessment) Merge(other ChemicalAssessment) ChemicalAssessment {
	out := NewChemicalAssessment(a.CableID, a.Window, a.Spans, a.Signals)
	if out.CableID == "" {
